...
Funcionario = db.define_table('funcionario',
    ...
    Field('solucao', 'text'),
    Field('atendente', 'string', label="Atendente"),
    Field('dia', 'date', label="Dia"),
    auth.signature,format = '%(nome)s'
    )
